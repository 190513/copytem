				...
				<form action="<c:url value="/produto/adiciona"/>" method="POST"
					...
					<div class="span6">
						...
						<div class="control-group">
							...
							<div class="controls">
								<textarea name="produto.descricao" id="produto.descricao"
					...
					<div class="span6">
							...
							<div class="controls">
								<div class="input-prepend">
									<span class="add-on">$</span> <input type="text"
										placeholder="preço" name="produto.preco" id="produto.preco">
								</div>
							</div>
						</div>
						<div class="control-group">
							<div class="control-group">
								...
								<div class="controls">
									<label class='radio'> <input value="M²" type="radio" name="produto.unidadeMedida">
										M²
									</label> <label class='radio'> <input value="UN" type="radio" name="produto.unidadeMedida">
										UN
									</label>
								</div>
							</div>
						...
						<div class="control-group">
							...
							<div class="controls">
								<select name="produto.categoria" id="produto.categoria" class='input-large'>
