				...
				<form action="<c:url value="/funcionario/adiciona"/>" method="POST"
					...
					<div class="span6">
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="funcionario.nome" id="funcionario.nome"
						...
						<div class="control-group">
							<label for="textfield" class="control-label">Data de Nascimento</label>
							<div class="controls">
								<input type="text" name="funcionario.dataNascimento"
									id="funcionario.dataNascimento" placeholder="Data de nascimento"
									class="input-medium">
							</div>
						</div>
					</div>
