				...
				<form action="<c:url value="/cliente/adiciona"/>" method="POST"
					...
					<div class="span6">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="cliente.cnpj" id="cliente.cnpj"
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="cliente.cpf" id="cliente.cpf"
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="cliente.email" id="cliente.email"
					...
					<div class="span6">
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="cliente.endereco" id="cliente.endereco"
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="cliente.bairro" id="cliente.bairro"
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="cliente.cidade" id="cliente.cidade"
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="cliente.estado" id="cliente.estado"
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="cliente.telResidencial"
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="cliente.telCelular"
									id="cliente.telCelular" placeholder="Celular"
									class="input-small">
							</div>
						</div>
